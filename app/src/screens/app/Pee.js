  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.btn, saving && styles.btnDisabled]} onPress={handleSave} disabled={saving}>
        {saving ? <ActivityIndicator color="#fff" /> : <Text style={styles.btnText}>Confirm Pee 💧</Text>}
      </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: "#00695c", borderRadius: 12, paddingVertical: 16, paddingHorizontal: 40, alignItems: "center" },
